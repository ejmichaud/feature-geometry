...
python /om2/user/ericjm/sae-clouds/scripts/feature_occurrences_pile_all.py \
    --save_dir /om2/user/ericjm/sae-clouds/experiments/all-occurrences0/histograms/ \
    --n_docs 50_000 \
    --layers $layers_arg
