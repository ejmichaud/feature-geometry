...
def load_W_dec(repo_id, sae_name):
    ...
    return torch.tensor(params['W_dec'])
...
def main():
    ...
    W_dec = load_W_dec(args.repo_id, args.sae_name)

    print("Computing angular similarities...")
    cos_sims = W_dec @ W_dec.T # this works since W_dec is normalized
