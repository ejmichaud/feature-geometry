...
SAVE_DIR="/om2/user/ericjm/sae-clouds/experiments/all-occurrences0/clusters_smc/"
...
python /om2/user/ericjm/sae-clouds/experiments/all-occurrences0/cluster_smc.py \
