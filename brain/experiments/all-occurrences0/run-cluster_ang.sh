...
SAVE_DIR="/om2/user/ericjm/sae-clouds/experiments/all-occurrences0/clusters_ang/"
...
python /om2/user/ericjm/sae-clouds/experiments/all-occurrences0/cluster_ang.py \
